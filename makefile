...
clean:
	-rm nim nim-server client.o client_game_tools.o nim_protocol_tools.o socket_IO_tools.o advanced_server.o nim_game.o IO_buffer.o buffered_socket.o server_handels_and_helper_functions.o

nim: client.o client_game_tools.o nim_protocol_tools.o socket_IO_tools.o buffered_socket.o IO_buffer.o 
	gcc -o $@ $^ $(FLAGS)

nim-server: advanced_server.o buffered_socket.o nim_protocol_tools.o IO_buffer.o nim_game.o socket_IO_tools.o client_list.o server_handels_and_helper_functions.o
	gcc -o $@ $^ $(FLAGS)
...
advanced_server.o: advanced_server.c advanced_server.h buffered_socket.h nim_protocol_tools.h IO_buffer.h nim_game.h client_list.h server_handels_and_helper_functions.h
	gcc -c $*.c $(FLAGS)

server_handels_and_helper_functions.o: server_handels_and_helper_functions.c server_handels_and_helper_functions.h buffered_socket.h nim_protocol_tools.h IO_buffer.h nim_game.h client_list.h
	gcc -c $*.c $(FLAGS)
