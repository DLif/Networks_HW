...
nim-server: advanced_server.o buffered_socket.o nim_protocol_tools.o IO_buffer.o nim_game.o socket_IO_tools.o client_list.o
	gcc -o $@ $^ $(FLAGS)
...
advanced_server.o: advanced_server.c advanced_server.h buffered_socket.h nim_protocol_tools.h IO_buffer.h nim_game.h client_list.h
	gcc -c $*.c $(FLAGS)
